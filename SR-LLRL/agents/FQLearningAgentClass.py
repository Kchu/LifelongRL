...
class FQLearningAgent(Agent):
    ''' Implementation for a Q Learning Agent '''

    def __init__(self, actions, name="FQ-learning", init_q=None, alpha=0.05, gamma=0.99, epsilon=0.1, explore="uniform", anneal=False, default_q=0.0):
        '''
        Args:
    ...
    def update(self, state, action, reward, next_state):
        ...
        reward =  reward + self.gamma * 1.0 - 1.0
