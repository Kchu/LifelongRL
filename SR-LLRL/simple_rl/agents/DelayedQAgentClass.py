...
class DelayedQAgent(Agent):
    ...
    def __init__(self, actions, init_q=None, name="Delayed-Q", gamma=0.99, m=5, epsilon1=0.1, default_q=1.0/(1.0-0.99)):
        '''
        Args:
    ...
    def instance_reset(self):
        ...
        self.episode_count = defaultdict(lambda : defaultdict(lambda: defaultdict(lambda: 0)))
        self.episode_reward = defaultdict(lambda: 0)
        self.reward_sa_init = defaultdict(lambda : defaultdict(lambda: 0))
        self.task_number = 0
